          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? (
                ...
                >
                  <p className="font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px] break-11">{i + 1}. {donator.donator}</p>
                  <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] break-11">{donator.donations}</p>
                </div>))
              ) : (
                <p className="font-epilogue font-normal text-[16px] leading-[26px] text-justify text-[#808191]">
